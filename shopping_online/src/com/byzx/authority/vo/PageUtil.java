...
public class PageUtil implements Serializable {
	...
	private static final long serialVersionUID = -4400430782743083805L;
	// 每页显示条数
	...
	public PageUtil(Integer pageSize, Integer totalNum, Integer pageNum, List<?> resultList, String url,
			StringBuffer params) {
		this.pageSize = pageSize;
