		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row placeholders">
					<!--添加权限表单 start-->
						<h2 style="color:red">给ID为【${CURR_USERID}】的用户修改权限</h2>
...
/* 华丽的分割线2#####################确认修改用户的权限######################## */	
		$(".confirmModificedAuth").click(function(){
			if(confirm('您确认修改该用户的权限？')){
            	...
            	var thisUserAuthIdsStr = v;
            	//alert(thisUserAuthIdsStr);
            	location.href="${pageContext.request.contextPath}/user/comfirmChangeAssign.action?thisUserAuthIdsStr="+thisUserAuthIdsStr;
            	/* 去后台将权限的所有id传过去 */
			}
