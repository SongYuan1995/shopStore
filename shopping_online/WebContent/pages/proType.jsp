...
//请求添加权限        
  		function updateProTyoe(){
  		  //修改权限1782836390
  	        	...
  	        	var id = v;
  	        	location.href="${pageContext.request.contextPath}/productList/updateType.action?id="+id;
  	        	//location.href="${pageContext.request.contextPath}/productList/updateProType.action";
  		...
  		$(function(){
	  		...
	  		$("#cancelUpdate").click(function(){
	  			...
	  			location.href="${pageContext.request.contextPath}/productList/list.action?";
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">商品分类</h1>
					...
					<div class="space-div"></div>
					<div>
							<button type="button" class="btn btn-default "  onclick="updateProTyoe()" style="width: 100px;">确认修改</button>
