        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <input type="text" name="userName"  placeholder="用户名" value="${param.userName }">
         	...
         	<div>
                 ...
                 <button type="button"   class="btn btn-primary addPlace" data-toggle="modal" data-target="#add-Place-form">添加品牌</button>
                </c:if>
                <!--添加品牌表单-->
                <div class="modal fade " id="add-Place-form" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                  <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" >添加产地</h4>
                      </div>
                      <div class="modal-body">
                      	<form class="add-brand-form" action="${pageContext.request.contextPath}/brand/addBrand.action" method="post">
							<div class="form-group">
	                            <label for="addBrandNameInput">产地名</label><label class="addDel" style="margin-left: 60px;" id="addBrandNameErrInput"></label> 
	                            <input type="text" name="brandName" value="" class="form-control addInput" id="addBrandNameInput" placeholder="品牌名">
	                        </div>
	                        <div class="form-group">
	                            <label for="addBrandLeter">产地编号</label><label class="addDel" style="margin-left: 70px;" id="addBrandLeterErrInput"></label>
	                         ...
	                         <div class="form-group">
	                            <label for="addBrandDesc">产地描述</label><label class="addDel" style="margin-left: 100px;" id="addBrandDescErrInput"></label>
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary add-place-submit">添加 </button>
                      </div>
                    </div>
                  </div>
                </div>
